...
img_bg = pygame.image.load("aurora_3.png") #正しい野田さん
img_title = pygame.image.load("opening_2.png") #フェイク野田さん
img_gameover = pygame.image.load("gameover.png") #正しい村上さん
img_gameclear = pygame.image.load("gameclear.png")  #フェイク村上さん
